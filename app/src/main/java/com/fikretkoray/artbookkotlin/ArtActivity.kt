package com.fikretkoray.artbookkotlin
...
import com.fikretkoray.artbookkotlin.databinding.ActivityArtBinding
...
class ArtActivity : AppCompatActivity() {
    ...
    fun saveButtonClicked(view: View) {
        ...
        val artists = binding.artistNameText.text.toString()
        ...
        if (selectedBitmap != null){
            ...
            try {
                ...
                statement.bindString(2,artists)
